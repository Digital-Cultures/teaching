...
//
//adapted from 2013-4-7 Brian Lee <cybexsoft@hotmail.com> by Tom Schofield, Feb 2016
...
void udpSerialPrint(word port, byte ip[4], word sentFrom, const char *data, word len) {
